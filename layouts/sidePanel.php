...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <?php if ($jabatan === 'staff' || $jabatan === 'administrasi'): ?>
        <li class="menu-header small">
        ...
        <?php if ($jabatan === 'staff' || $jabatan === 'administrasi' || $jabatan === 'petugas kontrol'): ?>
        <li class="menu-header small">
            <span class="menu-header-text">Data Kontrol Barang</span>
        </li>
        <?php endif; ?>

        <?php if ($jabatan === 'petugas kontrol'): ?>
