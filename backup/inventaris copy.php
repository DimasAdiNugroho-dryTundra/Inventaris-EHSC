                                    ...
                                    <form method="POST">
                                        <div class="mb-3">
                                            ...
                                            <select name="id_penerimaan" class="form-select" required>
                                                <?php
                                                // Ambil data penerimaan yang belum diinventaris
                                                $penerimaan_query = "SELECT pb.id_penerimaan, pb.nama_barang, d.nama_departemen 
                                                                    ...
                                                                    WHERE pb.id_penerimaan NOT IN (SELECT id_penerimaan FROM inventaris)";
