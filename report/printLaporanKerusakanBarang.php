...
$query = "SELECT kb.*, 
            ...
            WHERE 
            kb.id_kerusakan_barang = $id_kerusakan_barang";
...
try {
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        <p>Nomor: ' . $row['id_kerusakan_barang'] . '<br>Tanggal: ' . date('d/m/Y', strtotime($row['tanggal_kerusakan'])) . '<br>Departemen: ' . $row['nama_departemen'] . '</p>
        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
                <td><strong>Tanggal Kerusakan</strong></td>
                <td>' . $row['tanggal_kerusakan'] . '</td>
            </tr>
            <tr>
                <td><strong>Jumlah Kerusakan</strong></td>
                <td>' . $row['jumlah_kerusakan'] . ' ' . $row['satuan'] . '</td>
            </tr>
            <tr>
