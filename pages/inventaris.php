                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle"><?php echo $row['tanggal_perolehan']; ?>
                                        </td>
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle"><?php echo $row_zero['nama_ruangan']; ?>
                                        </td>
                                    ...
                                    <div class="modal fade"
                                        id="modal-delete-zero-<?php echo $row_zero['id_inventaris']; ?>" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
