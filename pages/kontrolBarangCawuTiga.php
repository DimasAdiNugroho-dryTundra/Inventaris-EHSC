                        ...
                        <div class="card">
                                        ...
                                        <div class="flex-grow-1 me-2">
                                            ...
                                            <select id="year" name="year" class="form-select"
                                                ...
                                                <option value="<?php echo $thn; ?>"
                                                    <?php if ($thn == $tahun) echo 'selected'; ?>>
                                                    <?php echo $thn; ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                            ...
                            <div class="card">
                                <h4 class="card-header d-flex justify-content-between align-items-center">
                                    Data Kontrol Barang Caturwulan Ke-3
                                ...
                                <div class="row p-3">
                                    <div class="col-md-12">
                                        <div class="alert alert-secondary" role="alert">
                                            Data yang tampil adalah Cawu 3 untuk tahun
                                            <?php echo $tahun; ?>.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table class="table table-hover table-sm">
                                        ...
                                        <tbody>
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Edit Kontrol Barang Catuwulan 3</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form method="POST">
                                                                ...
                                                                <input type="hidden" name="id_kontrol"
                                                                    value="<?php echo $row['id_kontrol_barang_cawu_tiga']; ?>">
                                            ...
                                            <!-- Modal Delete -->
                                            <div class="modal fade"
                                                id="deleteModal<?php echo $row['id_kontrol_barang_cawu_tiga']; ?>"
                                                tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-bs-dismiss="modal">Batal</button>
                                                            <a href="kontrolBarangCawutiga.php?delete=<?php echo $row['id_kontrol_barang_cawu_tiga']; ?>&year=<?php echo $tahun; ?>"
                            ...
                            <div class="modal fade" id="tambahKontrolModal" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Tambah Kontrol Barang Catuwulan 3</h5>
