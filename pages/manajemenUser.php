                                                        ...
                                                        <form method="POST" action="manajemenUser.php"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="nama"
                                                                    ...
                                                                    oninvalid="setCustomValidity('Silahkan masukan nama!')"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="username"
                                                                    ...
                                                                    oninvalid="setCustomValidity('Silahkan masukan username!')"
                                                                    oninput="setCustomValidity('')">
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="email" class="form-control" name="email"
                                                                    ...
                                                                    oninvalid="setCustomValidity('Silahkan masukan email yang valid, contoh: example@example.com!')"
                                                                    oninput="setCustomValidity('')">
                                                            </div>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="jabatan" class="form-select" required
                                                                    oninvalid="setCustomValidity('Silahkan pilih jabatan!')"
                                                                    oninput="setCustomValidity('')">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="hak_akses" class="form-select" required
                                                                    oninvalid="setCustomValidity('Silahkan pilih hak akses!')"
                                                                    oninput="setCustomValidity('')">
                                        ...
                                        <form method="POST" action="manajemenUser.php" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="password" name="password" class="form-control" required
                                                    oninvalid="setCustomValidity('Silahkan masukan password!')"
                                                    oninput="setCustomValidity('')">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Email</label>
