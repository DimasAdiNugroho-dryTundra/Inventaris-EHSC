                        ...
                        <div class="card">
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Edit Kontrol Barang Catuwulan 2</h5>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-bs-dismiss="modal">Batal</button>
                                                            <a href="kontrolBarangCawuDua.php?delete=<?php echo $row['id_kontrol_barang_cawu_dua']; ?>&year=<?php echo $tahun; ?>"
                            ...
                            <div class="modal fade" id="tambahKontrolModal" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Tambah Kontrol Barang Catuwulan 2</h5>
                                            ...
                                            <form method="POST" id="tambahKontrolForm">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="id_inventaris" class="form-select" required>
                                                        ...
                                                        <?php
                                                        $result = getInventarisTersedia($conn, $tahun, 'kontrol_barang_cawu_dua');
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            $tampil_nama_merk_ruangan = $row['nama_barang'] . ' - ' . $row['merk'] . ' - ' . $row['nama_ruangan'];
